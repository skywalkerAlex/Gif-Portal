...
// import { TEST_GIFS } from './TestData/testData';
          ...
          <div className="connected-container">
            ...
            {gifList.map((item, index) => (
              <Card className="bg-dark text-white" >
                ...
                <Card.Body>
                  <Card.Title>Votes <Badge bg="primary">{item.votes.toString()}</Badge></Card.Title>
                  <Card.Text>
                    {item.userAddress.toString()}
                  </Card.Text>
                  <Button variant="outline-success" size="sm" onClick={() => upVoteGif(item.gifLink)}>
                    Give us a vote!
                  </Button>
                </Card.Body>
              </Card>
